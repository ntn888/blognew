...
- Micro:Bit (nRF52833): low power wireless! When it comes to low power wireless, Nordic is the undisputed king. RF is in their name and they have gained good popularity in the industry over the past years. See [this post](/posts/micro_bit_breakout) for viable hobbyist boards.
...
[^2]: If you're interested in beginner boards or controller see [this post](/posts/begin_embedded).

[^1]:Edit: See [this post](/posts/pico_4m) about the PI Pico variant. This would be an excellent replacement for the bluepill. With 4M flash and 130MHz M0+ processor it is a no brainer for new projects!!
